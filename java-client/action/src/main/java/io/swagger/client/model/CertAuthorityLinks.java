...
public class CertAuthorityLinks {
  ...
  public CertAuthorityLinks refreshCrlUri(String refreshCrlUri) {
   ...
   /**
   * The URI of this Certificate Authority&#39;s Refresh CRL action. Deprecated since 2.19. Replaced by clientCertAuthorities.
   * @return refreshCrlUri
  **/
  @ApiModelProperty(value = "The URI of this Certificate Authority's Refresh CRL action. Deprecated since 2.19. Replaced by clientCertAuthorities.")
