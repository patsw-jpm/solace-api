...
public class MsgVpnBridgeClearEvent {
   ...
   * @return eventName
  **/
  @ApiModelProperty(value = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"ttl-exceeded\" - Time to live exceeded event. </pre> ")
