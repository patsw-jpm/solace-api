...
public class RestDeliveryPointApi {
    ...
    private com.squareup.okhttp.Call getMsgVpnRestDeliveryPointQueueBindingRequestHeaderValidateBeforeCall(String msgVpnName, String restDeliveryPointName, String queueBindingName, String headerName, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeaderCall(msgVpnName, restDeliveryPointName, queueBindingName, headerName, select, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse getMsgVpnRestDeliveryPointQueueBindingRequestHeader(String msgVpnName, String restDeliveryPointName, String queueBindingName, String headerName, List<String> select) throws ApiException {
        ApiResponse<MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse> resp = getMsgVpnRestDeliveryPointQueueBindingRequestHeaderWithHttpInfo(msgVpnName, restDeliveryPointName, queueBindingName, headerName, select);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse> getMsgVpnRestDeliveryPointQueueBindingRequestHeaderWithHttpInfo(String msgVpnName, String restDeliveryPointName, String queueBindingName, String headerName, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeaderValidateBeforeCall(msgVpnName, restDeliveryPointName, queueBindingName, headerName, select, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMsgVpnRestDeliveryPointQueueBindingRequestHeaderAsync(String msgVpnName, String restDeliveryPointName, String queueBindingName, String headerName, List<String> select, final ApiCallback<MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeaderValidateBeforeCall(msgVpnName, restDeliveryPointName, queueBindingName, headerName, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnRestDeliveryPointQueueBindingRequestHeaderResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getMsgVpnRestDeliveryPointQueueBindingRequestHeadersValidateBeforeCall(String msgVpnName, String restDeliveryPointName, String queueBindingName, Integer count, String cursor, List<String> where, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeadersCall(msgVpnName, restDeliveryPointName, queueBindingName, count, cursor, where, select, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse getMsgVpnRestDeliveryPointQueueBindingRequestHeaders(String msgVpnName, String restDeliveryPointName, String queueBindingName, Integer count, String cursor, List<String> where, List<String> select) throws ApiException {
        ApiResponse<MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse> resp = getMsgVpnRestDeliveryPointQueueBindingRequestHeadersWithHttpInfo(msgVpnName, restDeliveryPointName, queueBindingName, count, cursor, where, select);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse> getMsgVpnRestDeliveryPointQueueBindingRequestHeadersWithHttpInfo(String msgVpnName, String restDeliveryPointName, String queueBindingName, Integer count, String cursor, List<String> where, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeadersValidateBeforeCall(msgVpnName, restDeliveryPointName, queueBindingName, count, cursor, where, select, null, null);
    ...
    public com.squareup.okhttp.Call getMsgVpnRestDeliveryPointQueueBindingRequestHeadersAsync(String msgVpnName, String restDeliveryPointName, String queueBindingName, Integer count, String cursor, List<String> where, List<String> select, final ApiCallback<MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointQueueBindingRequestHeadersValidateBeforeCall(msgVpnName, restDeliveryPointName, queueBindingName, count, cursor, where, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnRestDeliveryPointQueueBindingRequestHeadersResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimValidateBeforeCall(String msgVpnName, String restDeliveryPointName, String restConsumerName, String oauthJwtClaimName, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimCall(msgVpnName, restDeliveryPointName, restConsumerName, oauthJwtClaimName, select, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim(String msgVpnName, String restDeliveryPointName, String restConsumerName, String oauthJwtClaimName, List<String> select) throws ApiException {
        ApiResponse<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse> resp = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimWithHttpInfo(msgVpnName, restDeliveryPointName, restConsumerName, oauthJwtClaimName, select);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse> getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimWithHttpInfo(String msgVpnName, String restDeliveryPointName, String restConsumerName, String oauthJwtClaimName, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimValidateBeforeCall(msgVpnName, restDeliveryPointName, restConsumerName, oauthJwtClaimName, select, null, null);
    ...
    public com.squareup.okhttp.Call getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimAsync(String msgVpnName, String restDeliveryPointName, String restConsumerName, String oauthJwtClaimName, List<String> select, final ApiCallback<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimValidateBeforeCall(msgVpnName, restDeliveryPointName, restConsumerName, oauthJwtClaimName, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsValidateBeforeCall(String msgVpnName, String restDeliveryPointName, String restConsumerName, Integer count, String cursor, List<String> where, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsCall(msgVpnName, restDeliveryPointName, restConsumerName, count, cursor, where, select, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaims(String msgVpnName, String restDeliveryPointName, String restConsumerName, Integer count, String cursor, List<String> where, List<String> select) throws ApiException {
        ApiResponse<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse> resp = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsWithHttpInfo(msgVpnName, restDeliveryPointName, restConsumerName, count, cursor, where, select);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse> getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsWithHttpInfo(String msgVpnName, String restDeliveryPointName, String restConsumerName, Integer count, String cursor, List<String> where, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsValidateBeforeCall(msgVpnName, restDeliveryPointName, restConsumerName, count, cursor, where, select, null, null);
    ...
    public com.squareup.okhttp.Call getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsAsync(String msgVpnName, String restDeliveryPointName, String restConsumerName, Integer count, String cursor, List<String> where, List<String> select, final ApiCallback<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsValidateBeforeCall(msgVpnName, restDeliveryPointName, restConsumerName, count, cursor, where, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MsgVpnRestDeliveryPointRestConsumerOauthJwtClaimsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
