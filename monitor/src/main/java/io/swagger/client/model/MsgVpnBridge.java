...
import io.swagger.client.model.MsgVpnBridgeCounter;
import io.swagger.client.model.MsgVpnBridgeRate;
...
public class MsgVpnBridge {
  ...
  @SerializedName("rxConnectionFailureCategory")
  private String rxConnectionFailureCategory = null;
  ...
  **/
  ...
  public MsgVpnBridge discardedRxMsgCount(Long discardedRxMsgCount) {
  ...
  **/
  ...
  public MsgVpnBridge discardedTxMsgCount(Long discardedTxMsgCount) {
  ...
  **/
  @ApiModelProperty(value = "The reason for the inbound connection failure from the Bridge. If there is no failure reason, an empty string (\"\") is returned.")
  ...
  **/
  @ApiModelProperty(value = "The number of seconds the broker waits for the bridge connection to be established before attempting a new connection.")
  ...
  **/
  ...
  public MsgVpnBridge rxConnectionFailureCategory(String rxConnectionFailureCategory) {
    this.rxConnectionFailureCategory = rxConnectionFailureCategory;
    return this;
  }
   ...
   * @return rxConnectionFailureCategory
  **/
  @ApiModelProperty(value = "The category of the inbound connection failure from the Bridge. The allowed values and their meaning are:  <pre> \"no-failure\" - There is no bridge failure. \"local-configuration-problem\" - The bridge failure is a local configuration problem. \"local-operational-state-problem\" - The bridge failure is an operational state problem. </pre>  Available since 2.18.")
  public String getRxConnectionFailureCategory() {
    return rxConnectionFailureCategory;
  }

  public void setRxConnectionFailureCategory(String rxConnectionFailureCategory) {
    this.rxConnectionFailureCategory = rxConnectionFailureCategory;
  }

  public MsgVpnBridge rxMsgCount(Long rxMsgCount) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.averageRxByteRate, msgVpnBridge.averageRxByteRate) &&
        ...
        Objects.equals(this.rxConnectionFailureCategory, msgVpnBridge.rxConnectionFailureCategory) &&
  ...
  public String toString() {
    ...
    sb.append("    rxConnectionFailureCategory: ").append(toIndentedString(rxConnectionFailureCategory)).append("\n");
