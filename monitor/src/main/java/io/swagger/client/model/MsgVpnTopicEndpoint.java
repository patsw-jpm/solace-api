...
public class MsgVpnTopicEndpoint {
  ...
  **/
  @ApiModelProperty(value = "The delay, in seconds, to apply to messages arriving on the Topic Endpoint before the messages are eligible for delivery. Available since 2.22.")
  ...
  **/
  @ApiModelProperty(value = "Enable or disable message redelivery. When enabled, the number of redelivery attempts is controlled by maxRedeliveryCount. When disabled, the message will never be delivered from the topic-endpoint more than once. Available since 2.18.")
  ...
  **/
  ...
  public MsgVpnTopicEndpoint transportRetransmitMsgCount(Long transportRetransmitMsgCount) {
  ...
  **/
  @ApiModelProperty(value = "The number of guaranteed messages that were retransmitted by the Topic Endpoint at the transport layer as part of a single delivery attempt. Available since 2.18.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessType, msgVpnTopicEndpoint.accessType) &&
        ...
        Objects.equals(this.transportRetransmitMsgCount, msgVpnTopicEndpoint.transportRetransmitMsgCount) &&
