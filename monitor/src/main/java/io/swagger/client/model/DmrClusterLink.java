...
public class DmrClusterLink {
  ...
  **/
  @ApiModelProperty(value = "The TCP maximum segment size, in bytes. Changes are applied to all existing connections.")
  ...
  **/
  @ApiModelProperty(value = "The cluster name of the remote node. Available since 2.17.")
