...
public class MsgVpnRestDeliveryPointQueueBinding {
   ...
   */
  @JsonAdapter(RequestTargetEvaluationEnum.Adapter.class)
  public enum RequestTargetEvaluationEnum {
    ...
    public static RequestTargetEvaluationEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<RequestTargetEvaluationEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RequestTargetEvaluationEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RequestTargetEvaluationEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return RequestTargetEvaluationEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("requestTargetEvaluation")
  private RequestTargetEvaluationEnum requestTargetEvaluation = null;
  ...
  **/
  @ApiModelProperty(value = "The request-target string being used when sending requests to a REST Consumer.")
  ...
  **/
  @ApiModelProperty(value = "The type of evaluation to perform on the request target. The allowed values and their meaning are:  <pre> \"none\" - Do not evaluate substitution expressions on the request target. \"substitution-expressions\" - Evaluate substitution expressions on the request target. </pre>  Available since 2.23.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gatewayReplaceTargetAuthorityEnabled, lastFailureReason, lastFailureTime, msgVpnName, postRequestTarget, queueBindingName, requestTargetEvaluation, restDeliveryPointName, up, uptime);
  }
