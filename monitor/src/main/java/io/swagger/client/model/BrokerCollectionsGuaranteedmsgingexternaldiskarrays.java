...
public class BrokerCollectionsGuaranteedmsgingexternaldiskarrays {
  @SerializedName("count")
  private Long count = null;

  public BrokerCollectionsGuaranteedmsgingexternaldiskarrays count(Long count) {
    this.count = count;
    return this;
  }

   /**
   * The total number of objects in the guaranteedMsgingExternalDiskArrays collection. Available since 2.18.
   * @return count
  **/
  @ApiModelProperty(value = "The total number of objects in the guaranteedMsgingExternalDiskArrays collection. Available since 2.18.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrokerCollectionsGuaranteedmsgingexternaldiskarrays brokerCollectionsGuaranteedmsgingexternaldiskarrays = (BrokerCollectionsGuaranteedmsgingexternaldiskarrays) o;
    return Objects.equals(this.count, brokerCollectionsGuaranteedmsgingexternaldiskarrays.count);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrokerCollectionsGuaranteedmsgingexternaldiskarrays {\n");
