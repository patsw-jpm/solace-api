...
public class Session {
  ...
  public Session createTime(Integer createTime) {
   ...
   * @return createTime
  **/
  @ApiModelProperty(value = "The timestamp of when the session was created. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  public Session lastActivityTime(Integer lastActivityTime) {
  ...
  **/
  @ApiModelProperty(value = "The timestamp of when the last activity on the session occurred. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
   ...
   * @return sessionId
  **/
  @ApiModelProperty(value = "The unique identifier for the session.")
  ...
  public Session sessionUsername(String sessionUsername) {
  ...
  **/
  @ApiModelProperty(value = "The username used for authorization.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.createTime, session.createTime) &&
        Objects.equals(this.lastActivityTime, session.lastActivityTime) &&
        Objects.equals(this.sessionId, session.sessionId) &&
        Objects.equals(this.sessionUsername, session.sessionUsername);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createTime, lastActivityTime, sessionId, sessionUsername);
  }
  ...
  public String toString() {
    ...
    sb.append("    sessionUsername: ").append(toIndentedString(sessionUsername)).append("\n");
    sb.append("}");
    return sb.toString();
  }
