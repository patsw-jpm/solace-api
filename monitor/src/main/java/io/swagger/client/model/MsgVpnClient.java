...
public class MsgVpnClient {
  ...
  @SerializedName("keepaliveEffectiveTimeout")
  private Integer keepaliveEffectiveTimeout = null;
  ...
  **/
  ...
  public MsgVpnClient keepalive(Boolean keepalive) {
   ...
   * @return keepalive
  **/
  @ApiModelProperty(value = "Indicates whether keepalive messages from the Client are received by the broker. Applicable for SMF and MQTT clients only. Available since 2.19.")
  ...
  public MsgVpnClient keepaliveEffectiveTimeout(Integer keepaliveEffectiveTimeout) {
    this.keepaliveEffectiveTimeout = keepaliveEffectiveTimeout;
    return this;
  }
   ...
   * @return keepaliveEffectiveTimeout
  **/
  @ApiModelProperty(value = "The maximum period of time the broker will accept inactivity from the Client before disconnecting, in seconds. Available since 2.19.")
  public Integer getKeepaliveEffectiveTimeout() {
    return keepaliveEffectiveTimeout;
  }

  public void setKeepaliveEffectiveTimeout(Integer keepaliveEffectiveTimeout) {
    this.keepaliveEffectiveTimeout = keepaliveEffectiveTimeout;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.aclProfileName, msgVpnClient.aclProfileName) &&
        ...
        Objects.equals(this.keepalive, msgVpnClient.keepalive) &&
        Objects.equals(this.keepaliveEffectiveTimeout, msgVpnClient.keepaliveEffectiveTimeout) &&
  ...
  public String toString() {
    ...
    sb.append("    keepaliveEffectiveTimeout: ").append(toIndentedString(keepaliveEffectiveTimeout)).append("\n");
