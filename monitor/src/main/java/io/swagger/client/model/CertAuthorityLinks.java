...
public class CertAuthorityLinks {
  ...
  **/
  @ApiModelProperty(value = "The URI of this Certificate Authority's collection of OCSP Responder Trusted Common Name objects. Deprecated since 2.19. Replaced by clientCertAuthorities.")
