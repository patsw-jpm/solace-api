 ...
 */
@ApiModel(description = "The rates for the Bridge. Deprecated since 2.13. All attributes in this object have been moved to the MsgVpnBridge object.")
...
public class MsgVpnBridgeRate {
  ...
  **/
  @ApiModelProperty(value = "The one minute average of the message rate received from the Bridge, in bytes per second (B/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
  ...
  **/
  @ApiModelProperty(value = "The one minute average of the message rate received from the Bridge, in messages per second (msg/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
  ...
  **/
  @ApiModelProperty(value = "The one minute average of the message rate transmitted to the Bridge, in bytes per second (B/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
  ...
  **/
  @ApiModelProperty(value = "The one minute average of the message rate transmitted to the Bridge, in messages per second (msg/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
   ...
   * @return rxByteRate
  **/
  @ApiModelProperty(value = "The current message rate received from the Bridge, in bytes per second (B/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
   ...
   * @return rxMsgRate
  **/
  @ApiModelProperty(value = "The current message rate received from the Bridge, in messages per second (msg/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
   ...
   * @return txByteRate
  **/
  @ApiModelProperty(value = "The current message rate transmitted to the Bridge, in bytes per second (B/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
   ...
   * @return txMsgRate
  **/
  @ApiModelProperty(value = "The current message rate transmitted to the Bridge, in messages per second (msg/sec). Deprecated since 2.13. This attribute has been moved to the MsgVpnBridge object.")
