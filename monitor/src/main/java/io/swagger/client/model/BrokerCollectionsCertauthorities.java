...
public class BrokerCollectionsCertauthorities {
   ...
   * @return count
  **/
  @ApiModelProperty(value = "The total number of objects in the certAuthorities collection. Deprecated since 2.19. Replaced by clientCertAuthorities and domainCertAuthorities.")
