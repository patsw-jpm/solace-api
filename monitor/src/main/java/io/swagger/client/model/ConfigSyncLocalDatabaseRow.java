...
public class ConfigSyncLocalDatabaseRow {
  ...
  public ConfigSyncLocalDatabaseRow lastRequest(String lastRequest) {
   ...
   * @return lastRequest
  **/
  @ApiModelProperty(value = "The last series of commands exchanged between Config Sync sites. Note that this value is only updated during transitions to any syncStatus that is not \"in-sync\".")
  ...
  public ConfigSyncLocalDatabaseRow lastResult(String lastResult) {
   ...
   * @return lastResult
  **/
  @ApiModelProperty(value = "The result of the last exchange between Config Sync sites.")
  ...
  public ConfigSyncLocalDatabaseRow name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name is \"site\" when the row type is \"router\", otherwise it is the Message VPN name.")
  ...
  public ConfigSyncLocalDatabaseRow role(String role) {
    this.role = role;
    return this;
  }
   ...
   * @return role
  **/
  @ApiModelProperty(value = "The row's role relative to the local broker. The allowed values and their meaning are:  <pre> \"unknown\" - The role is unknown. \"leader\" - In HA deployments, the role of the event broker and Message VPNs in the Config Sync database of both HA mates is always Leader. \"follower\" - Only replication-enabled Message VPNs on standby replication mates can have a Follower role. </pre> ")
  ...
  public ConfigSyncLocalDatabaseRow syncStatus(String syncStatus) {
   ...
   * @return syncStatus
  **/
  @ApiModelProperty(value = "The synchronization status of the row. The allowed values and their meaning are:  <pre> \"unknown\" - The state is unknown. \"in-sync\" - The config data is synchronized between Message VPNs. \"reconciling\" - The config data is reconciling between Message VPNs. \"blocked\" - The config data is blocked from reconciling due to an error. \"out-of-sync\" - The config data is out of sync between Message VPNs. \"down\" - The state is down due to configuration. </pre> ")
  ...
  public ConfigSyncLocalDatabaseRow timeInState(Integer timeInState) {
   ...
   * @return timeInState
  **/
  @ApiModelProperty(value = "The amount of time this row has remained in the shown syncStatus, in seconds.")
  ...
  public ConfigSyncLocalDatabaseRow type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the row. Can be one of \"router\" or \"vpn\". There is one \"router\" row and one row for each configured \"vpn\". Each row represents a table of information that is synchronized between Config Sync and replication mates. The allowed values and their meaning are:  <pre> \"router\" - The Config Sync database row is for the Router. \"vpn\" - The Config Sync database row is for a Message VPN. </pre> ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigSyncLocalDatabaseRow configSyncLocalDatabaseRow = (ConfigSyncLocalDatabaseRow) o;
    return Objects.equals(this.lastRequest, configSyncLocalDatabaseRow.lastRequest) &&
        Objects.equals(this.lastResult, configSyncLocalDatabaseRow.lastResult) &&
        Objects.equals(this.name, configSyncLocalDatabaseRow.name) &&
        Objects.equals(this.role, configSyncLocalDatabaseRow.role) &&
        Objects.equals(this.syncStatus, configSyncLocalDatabaseRow.syncStatus) &&
        Objects.equals(this.timeInState, configSyncLocalDatabaseRow.timeInState) &&
        Objects.equals(this.type, configSyncLocalDatabaseRow.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastRequest, lastResult, name, role, syncStatus, timeInState, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigSyncLocalDatabaseRow {\n");
