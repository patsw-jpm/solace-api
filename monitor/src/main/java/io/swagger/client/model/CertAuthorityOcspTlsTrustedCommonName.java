...
public class CertAuthorityOcspTlsTrustedCommonName {
  ...
  **/
  @ApiModelProperty(value = "The name of the Certificate Authority. Deprecated since 2.19. Replaced by clientCertAuthorities.")
  ...
  **/
  @ApiModelProperty(value = "The expected Trusted Common Name of the OCSP responder remote certificate. Deprecated since 2.19. Replaced by clientCertAuthorities.")
