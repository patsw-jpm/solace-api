...
public class MsgVpnRestDeliveryPointRestConsumerCollectionsTlstrustedcommonnames {
   ...
   * @return count
  **/
  @ApiModelProperty(value = "The total number of objects in the tlsTrustedCommonNames collection. Deprecated since 2.17. Common Name validation has been replaced by Server Certificate Name validation.")
