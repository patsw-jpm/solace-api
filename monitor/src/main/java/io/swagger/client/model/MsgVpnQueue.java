...
public class MsgVpnQueue {
  ...
  @SerializedName("transportRetransmitMsgCount")
  private Long transportRetransmitMsgCount = null;
  ...
  **/
  @ApiModelProperty(value = "Enable or disable the ability for client applications to query the message delivery count of messages received from the Queue. This is a controlled availability feature. Please contact Solace to find out if this feature is supported for your use case. Available since 2.19.")
  ...
  **/
  @ApiModelProperty(value = "The delay, in seconds, to apply to messages arriving on the Queue before the messages are eligible for delivery. Available since 2.22.")
  ...
  **/
  ...
  public MsgVpnQueue transportRetransmitMsgCount(Long transportRetransmitMsgCount) {
    this.transportRetransmitMsgCount = transportRetransmitMsgCount;
    return this;
  }
   ...
   * @return transportRetransmitMsgCount
  **/
  @ApiModelProperty(value = "The number of guaranteed messages that were retransmitted by the Queue at the transport layer as part of a single delivery attempt. Available since 2.18.")
  public Long getTransportRetransmitMsgCount() {
    return transportRetransmitMsgCount;
  }

  public void setTransportRetransmitMsgCount(Long transportRetransmitMsgCount) {
    this.transportRetransmitMsgCount = transportRetransmitMsgCount;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessType, msgVpnQueue.accessType) &&
        ...
        Objects.equals(this.transportRetransmitMsgCount, msgVpnQueue.transportRetransmitMsgCount) &&
  ...
  public String toString() {
    ...
    sb.append("    transportRetransmitMsgCount: ").append(toIndentedString(transportRetransmitMsgCount)).append("\n");
