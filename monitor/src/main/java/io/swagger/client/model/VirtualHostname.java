...
public class VirtualHostname {
   ...
   * @return enabled
  **/
  @ApiModelProperty(value = "Enable or disable Virtual Hostname to Message VPN mapping.")
   ...
   * @return msgVpnName
  **/
  @ApiModelProperty(value = "The message VPN to which this virtual hostname is mapped.")
