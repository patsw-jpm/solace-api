...
public class DmrCluster {
  ...
  @SerializedName("subscriptionDbBuildPercentage")
  private Long subscriptionDbBuildPercentage = null;
  ...
  **/
  ...
  public DmrCluster subscriptionDbBuildPercentage(Long subscriptionDbBuildPercentage) {
    this.subscriptionDbBuildPercentage = subscriptionDbBuildPercentage;
    return this;
  }

   /**
   * Cluster Subscription Database build completion percentage. Available since 2.20.
   * @return subscriptionDbBuildPercentage
  **/
  @ApiModelProperty(value = "Cluster Subscription Database build completion percentage. Available since 2.20.")
  public Long getSubscriptionDbBuildPercentage() {
    return subscriptionDbBuildPercentage;
  }

  public void setSubscriptionDbBuildPercentage(Long subscriptionDbBuildPercentage) {
    this.subscriptionDbBuildPercentage = subscriptionDbBuildPercentage;
  }
  ...
  **/
  @ApiModelProperty(value = "Indicates whether the common name provided by the remote broker is enforced against the list of trusted common names configured for the Link. If enabled, the certificate's common name must match one of the trusted common names for the Link to be accepted. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.authenticationBasicEnabled, dmrCluster.authenticationBasicEnabled) &&
        ...
        Objects.equals(this.subscriptionDbBuildPercentage, dmrCluster.subscriptionDbBuildPercentage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationBasicEnabled, authenticationBasicType, authenticationClientCertEnabled, directOnlyEnabled, dmrClusterName, enabled, failureReason, nodeName, subscriptionDbBuildPercentage, tlsServerCertEnforceTrustedCommonNameEnabled, tlsServerCertMaxChainDepth, tlsServerCertValidateDateEnabled, tlsServerCertValidateNameEnabled, up, uptime);
  }
  ...
  public String toString() {
    ...
    sb.append("    subscriptionDbBuildPercentage: ").append(toIndentedString(subscriptionDbBuildPercentage)).append("\n");
