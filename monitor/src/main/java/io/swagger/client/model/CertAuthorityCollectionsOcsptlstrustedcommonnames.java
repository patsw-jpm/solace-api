...
public class CertAuthorityCollectionsOcsptlstrustedcommonnames {
   ...
   * @return count
  **/
  @ApiModelProperty(value = "The total number of objects in the ocspTlsTrustedCommonNames collection. Deprecated since 2.19. Replaced by clientCertAuthorities.")
