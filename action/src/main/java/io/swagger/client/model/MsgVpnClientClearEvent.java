...
public class MsgVpnClientClearEvent {
   ...
   * @return eventName
  **/
  @ApiModelProperty(value = "The name of the event. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. The allowed values and their meaning are:  <pre> \"large-message\" - The Client large message received event. \"message-too-big\" - The Client message too big event. \"parse-error\" - The Client parse error event. \"max-eliding-topic-count\" - The Client maximum eliding topics reached event. </pre> ")
