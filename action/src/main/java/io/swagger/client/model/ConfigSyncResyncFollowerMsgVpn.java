...
public class ConfigSyncResyncFollowerMsgVpn {
  @SerializedName("msgVpnName")
  private String msgVpnName = null;

  public ConfigSyncResyncFollowerMsgVpn msgVpnName(String msgVpnName) {
    this.msgVpnName = msgVpnName;
    return this;
  }

   /**
   * The name of the Message VPN. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.
   * @return msgVpnName
  **/
  @ApiModelProperty(value = "The name of the Message VPN. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigSyncResyncFollowerMsgVpn configSyncResyncFollowerMsgVpn = (ConfigSyncResyncFollowerMsgVpn) o;
    return Objects.equals(this.msgVpnName, configSyncResyncFollowerMsgVpn.msgVpnName);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigSyncResyncFollowerMsgVpn {\n");
