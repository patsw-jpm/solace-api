...
public class MsgVpnQueueStartReplay {
  @SerializedName("afterMsg")
  private String afterMsg = null;
  ...
  public MsgVpnQueueStartReplay afterMsg(String afterMsg) {
    this.afterMsg = afterMsg;
    return this;
  }

   /**
   * The Message after which to begin replay, identified by its Replication Group Message ID. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Available since 2.21.
   * @return afterMsg
  **/
  @ApiModelProperty(value = "The Message after which to begin replay, identified by its Replication Group Message ID. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. Available since 2.21.")
  ...
  public MsgVpnQueueStartReplay fromTime(Integer fromTime) {
   ...
   /**
   * The time to begin replaying messages from. The value must be no less than the time that the replay log was created. To play back the whole log, this parameter must be omitted. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
   * @return fromTime
  **/
  @ApiModelProperty(value = "The time to begin replaying messages from. The value must be no less than the time that the replay log was created. To play back the whole log, this parameter must be omitted. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).")
  ...
  **/
  @ApiModelProperty(value = "The name of the Replay Log. This attribute is absent from a GET and not updated when absent in a PUT, subject to the exceptions in note 4.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.afterMsg, msgVpnQueueStartReplay.afterMsg) &&
        Objects.equals(this.fromTime, msgVpnQueueStartReplay.fromTime) &&
        Objects.equals(this.replayLogName, msgVpnQueueStartReplay.replayLogName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(afterMsg, fromTime, replayLogName);
  }
  ...
  public String toString() {
    ...
    sb.append("    afterMsg: ").append(toIndentedString(afterMsg)).append("\n");
