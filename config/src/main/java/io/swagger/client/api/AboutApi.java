...
public class AboutApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAboutApiCall(String opaquePassword, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAboutApiValidateBeforeCall(String opaquePassword, List<String> select, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getAboutApiCall(opaquePassword, select, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AboutApiResponse getAboutApi(String opaquePassword, List<String> select) throws ApiException {
        ApiResponse<AboutApiResponse> resp = getAboutApiWithHttpInfo(opaquePassword, select);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AboutApiResponse> getAboutApiWithHttpInfo(String opaquePassword, List<String> select) throws ApiException {
        com.squareup.okhttp.Call call = getAboutApiValidateBeforeCall(opaquePassword, select, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAboutApiAsync(String opaquePassword, List<String> select, final ApiCallback<AboutApiResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAboutApiValidateBeforeCall(opaquePassword, select, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AboutApiResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
