...
public class MsgVpnBridgeTlsTrustedCommonName {
   ...
   * @return bridgeName
  **/
  @ApiModelProperty(value = "The name of the Bridge. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.")
  ...
  **/
   ...
   * @return msgVpnName
  **/
  @ApiModelProperty(value = "The name of the Message VPN. Deprecated since 2.18. Common Name validation has been replaced by Server Certificate Name validation.")
