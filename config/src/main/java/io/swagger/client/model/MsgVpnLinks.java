...
public class MsgVpnLinks {
  ...
  **/
  ...
  public MsgVpnLinks jndiConnectionFactoriesUri(String jndiConnectionFactoriesUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of JNDI Connection Factory objects. Available since 2.4.
   * @return jndiConnectionFactoriesUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Connection Factory objects. Available since 2.4.")
  ...
  public MsgVpnLinks jndiQueuesUri(String jndiQueuesUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of JNDI Queue objects. Available since 2.4.
   * @return jndiQueuesUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Queue objects. Available since 2.4.")
  ...
  public MsgVpnLinks jndiTopicsUri(String jndiTopicsUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of JNDI Topic objects. Available since 2.4.
   * @return jndiTopicsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of JNDI Topic objects. Available since 2.4.")
  ...
  **/
  ...
  public MsgVpnLinks mqttSessionsUri(String mqttSessionsUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of MQTT Session objects. Available since 2.4.
   * @return mqttSessionsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of MQTT Session objects. Available since 2.4.")
  ...
  **/
  ...
  public MsgVpnLinks replicatedTopicsUri(String replicatedTopicsUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of Replicated Topic objects. Available since 2.4.
   * @return replicatedTopicsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Replicated Topic objects. Available since 2.4.")
  ...
  **/
  ...
  public MsgVpnLinks topicEndpointsUri(String topicEndpointsUri) {
   ...
   /**
   * The URI of this Message VPN&#39;s collection of Topic Endpoint objects. Available since 2.4.
   * @return topicEndpointsUri
  **/
  @ApiModelProperty(value = "The URI of this Message VPN's collection of Topic Endpoint objects. Available since 2.4.")
