...
public class DomainCertAuthority {
  ...
  **/
   ...
   * @return certContent
  **/
  @ApiModelProperty(value = "The PEM formatted content for the trusted root certificate of a domain Certificate Authority. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"\"`.")
